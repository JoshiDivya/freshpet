...
class ProductsList extends Component {
  ...
  componentDidMount() {
    Axios.get('https://fresh-pet.herokuapp.com/api/v1/products').then(({ data: { products } }) => {
  ...
  handleCreateProduct = () => {
    ...
    if (
      ...
      Axios.post('https://fresh-pet.herokuapp.com/api/v1/products', {
        name,
        description,
        petCategory,
        subCategory,
  ...
  handleUpdateProduct = () => {
    ...
    if (
      ...
      Axios.patch(`https://fresh-pet.herokuapp.com/api/v1/products/product/${productId}`, {
        name,
        description,
        petCategory,
        subCategory,
